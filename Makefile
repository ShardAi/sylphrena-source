...
syl_input: sylphrena-input/main.cpp sylphrena-input/syl_socketClient.h sylphrena-input/syl_socketClient.cpp
	$(CXX) -std=c++11 -pthread sylphrena-input/main.cpp sylphrena-input/syl_socketClient.cpp sylphrena-input/syl_socketClient.h  -o sylphrena-input/syl_input $(LDLIBS)
